...
static const char *const expected_exports[] = {
    ...
    "proton_window_minimize",
    "proton_window_maximize",
    "proton_window_restore",
    "proton_window_set_fullscreen",
    "proton_window_set_position",
    "proton_window_set_always_on_top",
    "proton_window_set_zoom_percent",
    "proton_window_state_json",
    "proton_window_set_close_interception",
    ...
    "proton_view_load_html",
    "proton_view_eval",
    "proton_view_browser_command_json",
