...
This page lists every `proton_cli` command and its options. Application IPC commands are documented separately in [Commands](commands-events.md). Configuration file fields are defined in [project configuration](configuration.md).
