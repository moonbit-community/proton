...
| `minimum_system_version` | string | macOS only; `major.minor[.patch]`. Defaults to the highest packaged Mach-O deployment target; an explicit value may raise, but cannot lower, that minimum. Does not change compilation targets. |
