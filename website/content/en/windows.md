...
Native window decorations and available controls differ across platforms. Check the [window API](https://mooncakes.io/docs/moonbit-community/proton@0.2.11/) before relying on platform-specific methods. Keep frontend titlebar layout and native configuration together when using an overlay titlebar.
